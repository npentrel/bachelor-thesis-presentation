...
%ule[path=preliminaries/spatialNarrative]{spatialNarrative}
%dule[path=preliminaries/narrativePath]{narrativePath}
%ule[path=preliminaries/status]{status}

\begin{frame}
  \frametitle{Ordered Informaton Graphs II }
...
\mhcgraphics[width=5.5cm]{researchProject/dependencyGraphPythTheo2}
